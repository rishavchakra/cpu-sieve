...
def get_disk_image(image_path, is_save_checkpoint):
    # if is_save_checkpoint:
    #     return obtain_resource("x86-ubuntu-18.04-img")
    # else:
    return DiskImageResource(image_path, root_partition=".")
...
disk_image = get_disk_image("bench/parsec/parsec-image/parsec", args.save_checkpoint)
